                            ...
                            <div key={data.id}>
                                <div className="grid grid-cols-1 sm:grid-cols-2">
                                    ...
                                    <div className="flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                                        ...
                                        data-aos-once='true'
                                         className="text-2xl sm:text-6xl lg:text-7xl font-bold">{data.subtitle}</h1>
                                        <h1 data-aos='zoom-out'
                                        data-aos-duration='500'
                                        data-aos-once='true'
                                        ...
                                        data-aos-offset='0'
                                        data-aos-delay='300'>
                                            <button className="bg-primary text-white cursor-pointer hover:scale-105 duration-300 py-2 px-8 rounded-full relative z-10 handler = {handleOrderPopup}">
                                                Shop By Category
                                            </button>
                                        </div>
                                    </div>
